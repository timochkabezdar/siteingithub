...
<body class="bg-light">
    <div class="container" style="max-width: 400px;  margin: 150px auto;">
        <div class="form">
            <form action="php/register.php" method="post" class="d-flex flex-column gap-3">
                ...
                <input class="form-control" type="text" name="username" placeholder="Введите ФИО" required>
                <input class="form-control" type="number" name="phone" placeholder="Введите номер телефона" required>
        ...
        <div class="login">Есть аккаунт? <a href="login.php">Авторизуйтесь</a></div>
    </div>
</body>
</html>